            ...
            <Stack spacing={2} sx={{ mt: 2 }}>
              ...
              <Card variant="outlined" sx={{ border: `3px solid ${P.yellow.border}` }}>
                <CardContent>
                  ...
                  <LinearProgress variant="determinate" value={(scores.total / 6) * 100} sx={{ mt: 1, height: 12, borderRadius: 1, bgcolor: P.yellow.bg, '& .MuiLinearProgress-bar': { bgcolor: P.yellow.border } }} />
                </CardContent>
              </Card>
            </Stack>
          </Box>
