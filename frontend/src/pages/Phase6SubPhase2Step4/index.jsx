      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...cardSx(P.blue), mb: 3 }}>
            ...
            <Typography variant="h6" sx={{ color: P.blue.shadow }}>Step 4: Elaborate - Responding to Feedback</Typography>
          </Box>
        </motion.div>
        ...
        {sushiDone && (
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
              <Box
                component="button"
                onClick={() => navigate('/phase6/subphase/2/step/4/interaction/1')}
                sx={{
                  ...cardSx(P.green),
                  cursor: 'pointer',
