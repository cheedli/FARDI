...
/**
 * Phase 4 Step 3 - Level A2 - Task B: Sentence Expansion
...
export default function Phase4Step4RemedialA2TaskB() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/3/remedial/a2/taskC') }, [])
  ...
  const handleContinue = () => {
    navigate('/phase4/step/3/remedial/a2/taskC')
  }
