...
export default function RemedialB1Results() {
  ...
  const calculateFinalScore = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        sessionStorage.setItem('phase4_step4_b1_next_url', data.data.next_url || (passed ? '/phase4/step/3' : '/phase4/step/3/remedial/b1/taskA'))
      }
    } catch (error) {
  ...
  const handleRedirect = () => {
    ...
    navigate(sessionStorage.getItem('phase4_step4_b1_next_url') || (scores.passed ? '/phase4/step/3/remedial/b2/taskA' : '/phase4/step/3/remedial/b1/taskA'))
  }
