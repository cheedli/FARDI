...
/**
 * Phase 4 Step 3 - Remedial B1 - Task B: Definition Duel
...
export default function RemedialB1TaskB() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/3/remedial/b1/taskC') }, [])
            ...
            <Box sx={{ mt: 4 }}>
              <Box sx={{ bgcolor: P.green.bg, border: `2px solid ${P.green.border}`, borderRadius: '20px', boxShadow: `4px 4px 0 ${P.green.shadow}`, p: 3, mb: 3 }}>
                ...
                <Box sx={{ mt: 3, textAlign: 'center' }}>
                  <Box component="button" onClick={() => navigate('/phase4/step/3/remedial/b1/taskC')} sx={{
                    bgcolor: P.green.bg, border: `2px solid ${P.green.border}`,
