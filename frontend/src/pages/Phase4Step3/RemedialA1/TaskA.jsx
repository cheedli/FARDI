...
/**
 * Phase 4 Step 3 - Level A1 - Task A: Drag and Drop Matching
...
export default function Phase4Step4RemedialA1TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/3/remedial/a1/taskB') }, [])
  ...
  const handleContinue = () => {
    // Navigate to Task B
    navigate('/phase4/step/3/remedial/a1/taskB')
  }
