...
/**
 * Phase 4 Step 3 - Level A1 - Task C: Grammar Exercise (Simple Sentences)
...
export default function Phase4Step4RemedialA1TaskC() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/3/remedial/a2/taskA') }, [])
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        sessionStorage.setItem('phase4_step4_a1_next_url', data.data.next_url || (passed ? '/phase4/step/3' : '/phase4/step/3/remedial/a1/taskA'))
      }
    } catch (error) {
    ...
    setTimeout(() => {
      ...
      navigate(sessionStorage.getItem('phase4_step4_a1_next_url') || (passed ? '/phase4/step/3/remedial/a2/taskA' : '/phase4/step/3/remedial/a1/taskA'))
    }, 5000) // 5 second delay
  }
