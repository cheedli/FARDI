...
export default function Phase4Step5RemedialB2TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/5/remedial/b2/taskB') }, [])
        ...
        <Container maxWidth="md">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <Stack justifyContent="center" alignItems="center">
              <Box component="button" onClick={() => navigate('/phase4/step/5/remedial/b2/taskB')} sx={{ bgcolor: P.green.bg, border: `2px solid ${P.green.border}`, borderRadius: '16px', boxShadow: `4px 4px 0 ${P.green.shadow}`, px: 5, py: 2, cursor: 'pointer', fontSize: '1.1rem', fontWeight: 'bold', color: P.green.shadow, '&:hover': { transform: 'translate(-2px,-2px)', boxShadow: `6px 6px 0 ${P.green.shadow}` } }}>Continue to Task B →</Box>
            </Stack>
          </motion.div>
        </Container>
      </Box>
