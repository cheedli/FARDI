...
export default function RemedialB1TaskD() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/2/remedial/b1/taskE') }, [])
  ...
  const handleFinish = async () => {
    ...
    let nextUrl = '/phase4/step/2/remedial/b1/taskA'
    try {
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <Box sx={{ ...cardSx('purple'), textAlign: 'center', p: 5 }}>
              ...
              <Stack direction="row" spacing={2} justifyContent="center">
                ...
                <Box
                  component="button"
                  onClick={() => navigate('/phase4/step/2/remedial/b1/taskE')}
                  sx={{
