...
export default function RemedialB1TaskA() {
  ...
  const handleContinue = () => navigate('/phase4/step/2/remedial/b1/taskB')
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <Box sx={{ p: 3, mb: 3, bgcolor: P.blue.bg, border: `2px solid ${P.blue.border}`, borderRadius: 3, boxShadow: `4px 4px 0 ${P.blue.shadow}` }}>
            <Typography variant="h5" fontWeight={800} color={P.blue.border}>Phase 4 - Step 2: Remedial Activities</Typography>
