...
export default function Phase4_2Step3RemedialB1Results() {
  ...
  const logRemedialCompletion = async (score) => {
    try {
      const data = await requestPhase42FinalScore(3, 'b1', { total_score: score })
  ...
  const handleContinue = () => {
    ...
    if (results.passed) { navigate('/phase4_2/step/3/remedial/b2/taskA') } else { navigate('/phase4_2/step/3/remedial/b1/taskA') }
  }
