...
export default function RemedialB2TaskF() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/2/remedial/b2/results') }, [])
        ...
        <Container maxWidth="md">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <Box sx={{ textAlign: 'center' }}>
              <Box component="button" onClick={() => navigate('/phase4/step/2/remedial/b2/results')}
                sx={{
