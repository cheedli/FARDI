...
export default function RemedialB2Results() {
  ...
  const handleRedirect = () => {
    ...
    if (scores.passed) navigate('/phase4/step/2/remedial/c1/taskA')
    else navigate('/phase4/step/2/remedial/b2/taskA')
  }
          ...
          <Box sx={{ ...cardSx(resultColor), mb: 3, textAlign: 'center' }}>
            ...
            <Box sx={{ ...cardSx(scores.passed ? 'green' : 'red'), mt: 2 }}>
              <Typography variant="h6" fontWeight="bold">
                {scores.passed ? '✅ You have passed Step 2 Remedial B2!' : '❌ Score below passing threshold'}
              </Typography>
