...
export default function RemedialA1TaskC() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/2/remedial/a2/taskA') }, [])
  ...
  const handleContinue = async () => {
    ...
    let nextUrl = passed ? '/phase4/step/3' : '/phase4/step/2/remedial/a1/taskA'
          ...
          {!submitted ? (
            ...
            <Box sx={{
              ...
              <Typography variant="h6" sx={{ mt: 3, color: finalScore.passed ? P.green.shadow : P.orange.shadow }}>
                {finalScore.passed ? 'You have passed Step 2 Remedial A1!' : 'Score below passing threshold'}
              </Typography>
              <Typography variant="body1" sx={{ mt: 1, color: finalScore.passed ? P.green.shadow : P.orange.shadow, opacity: 0.8 }}>
                {finalScore.passed ? 'Proceeding to dashboard...' : 'Restarting Step 2 Remedial A1 to help you improve...'}
              </Typography>
