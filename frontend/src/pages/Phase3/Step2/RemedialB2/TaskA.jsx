...
export default function Phase3Step2RemedialB2TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase3/step/2/remedial/c1/taskA') }, [])
  const { saveNow } = useProgressSave({ phase: 3, subphase: null, step: 2, interaction: 1, context: 'remedial_b2' })
  ...
  const handleNext = () => {
    navigate('/phase3/step/2/remedial/c1/taskA')
  }
      ...
      <Container maxWidth="md" sx={{ pt: { xs: 3, md: 4 }, pb: 6 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, mt: 4 }}>
          ...
          {showResults && (
            ...
            >
              Continue to C1 Practice <ArrowForwardIcon />
            </Box>
          )}
        </Box>
