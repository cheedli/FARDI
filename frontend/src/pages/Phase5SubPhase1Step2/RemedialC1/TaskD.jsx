...
export default function Phase5Step2RemedialC1TaskD() {
  ...
  const handleContinue = async () => {
    ...
    const passed = totalScore >= Math.ceil((3 + 8 + 6 + 6) * 0.8)
    try { await phase5API.calculateRemedialScore(2, 'C1', { task_a_score: taskAScore, task_b_score: taskBScore, task_c_score: taskCScore, task_d_score: taskDScore }) } catch (e) { console.error(e) }
    navigate(passed ? '/dashboard' : '/phase5/subphase/1/step/2/remedial/c1/task/a')
  }
