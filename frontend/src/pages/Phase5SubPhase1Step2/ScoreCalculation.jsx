...
export default function Phase5Step2ScoreCalculation() {
  ...
  usePhase5ScoreResume({ subphase: 1, step: 2, scores, routing })
  ...
  const calculateScore = async () => {
    ...
    try {
      ...
      setScores({ interaction1Game: interaction1GameScore, interaction1Writing: interaction1WritingScore, interaction2: interaction2Score, interaction3Game: interaction3GameScore, interaction3Revision: interaction3RevisionScore, total: totalScore })
      ...
      if (result.success && result.data) {
        ...
        const nextUrl = data.total?.next_url || data.next_url || (shouldProceed
          ? '/phase5/subphase/1/step/3'
          : `/phase5/subphase/1/step/2/remedial/${remedialLevel.toLowerCase()}/task/a`)
  ...
  const scoreItems = [
    ...
    { label: 'Interaction 1 (Writing)', value: scores.interaction1Writing, max: 5 },
    { label: 'Interaction 2 (Explanation)', value: scores.interaction2, max: 5 },
    { label: 'Interaction 3 (Game)', value: scores.interaction3Game, max: 1 },
    { label: 'Interaction 3 (Revision)', value: scores.interaction3Revision, max: 5 },
  ]
            ...
            <Box sx={{ ...cardSx(routing.shouldProceed ? P.green : P.orange), mb: 3 }}>
              ...
              <Typography variant="body1" sx={{ mb: 2 }} color="text.secondary">
                {routing.shouldProceed
                  ? `You've scored ${routing.totalScore} points! You'll proceed directly to Step 3.`
