...
/**
 * Phase 4 Step 4 - Remedial C1 - Task G: Correction Crusade
...
export default function Phase4Step5RemedialC1TaskG() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/step/4/remedial/c1/results') }, [])
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...cardSx('orange'), mb: 3 }}>
            <Typography variant="h4" sx={{ fontWeight: 800, color: P.orange.border, mb: 1 }}>Phase 4 Step 4: Evaluate - Remedial Practice</Typography>
          ...
          {submitted && (
            <Stack spacing={3}>
              ...
              <Box
                component="button"
                onClick={() => navigate('/phase4/step/4/remedial/c1/results')}
