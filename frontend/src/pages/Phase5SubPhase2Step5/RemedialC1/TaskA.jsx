...
export default function Phase5SubPhase2Step5RemedialC1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(5, 'C1', 'A', finalScore, 5, 2) } catch (error) { console.error('Failed to log task completion:', error) }
  }
  const handleContinue = () => navigate('/phase5/subphase/2/step/5/remedial/c1/task/b')
