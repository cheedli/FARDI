...
export default function Phase5Step4RemedialB1TaskC() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase5/subphase/1/step/4/remedial/b1/task/a') }, [])
  ...
  const handleContinue = async () => {
    ...
    let nextUrl = '/phase5/subphase/1/step/4/remedial/b1/task/a'
    try {
      const result = await phase5API.calculateRemedialScore(4, 'B1', { task_a_score: a, task_b_score: b, task_c_score: c })
