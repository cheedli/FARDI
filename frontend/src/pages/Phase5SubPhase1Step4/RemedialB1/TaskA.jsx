...
export default function Phase5Step4RemedialB1TaskA() {
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(4, 'B1', 'A', finalScore, 3, 0) } catch (e) { console.error(e) }
  }

  const handleContinue = () => { navigate('/phase5/subphase/1/step/4/remedial/b1/task/b') }
