...
export default function Phase5Step4RemedialA2TaskC() {
  ...
  const handleContinue = async () => {
    ...
    try { await phase5API.calculateRemedialScore(4, 'A2', { task_a_score: a, task_b_score: b, task_c_score: c }) } catch (e) { console.error(e) }
    if (passed) navigate('/dashboard'); else navigate('/phase5/subphase/1/step/4/remedial/a2/task/a')
  }
