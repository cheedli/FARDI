...
export default function Phase5Step4RemedialC1TaskA() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 1, step: 4, interaction: 1, context: 'remedial_c1' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(4, 'C1', 'A', finalScore, 5, 0) } catch (e) { console.error(e) }
  }

  const handleContinue = () => { navigate('/phase5/subphase/1/step/4/remedial/c1/task/b') }
