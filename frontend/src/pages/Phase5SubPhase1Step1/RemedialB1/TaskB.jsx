...
export default function Phase5Step1RemedialB1TaskB() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase5/subphase/1/step/1/remedial/b1/task/c') }, [])
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{
            ...
            <Typography variant="h6" gutterBottom fontWeight="bold">Task B: Proposal Builder</Typography>
