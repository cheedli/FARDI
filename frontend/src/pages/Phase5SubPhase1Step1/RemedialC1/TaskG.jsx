...
export default function Phase5Step1RemedialC1TaskG() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase5/subphase/1/step/1/remedial/c1/task/h') }, [])
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{
            ...
            <Typography variant="h6" gutterBottom fontWeight="bold">Task G: Debate Duel Advanced</Typography>
        ...
        {!submitted ? (
          <>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
              <Box sx={{
                ...
                <Typography variant="h6" gutterBottom sx={{ color: P.blue.border }}>{SUBJUNCTIVE_SENTENCES[currentIndex].template}</Typography>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            <Box sx={{
              ...
              <Typography variant="h5" fontWeight="bold" sx={{ color: P.green.shadow }} gutterBottom>✓ Task G Complete!</Typography>
