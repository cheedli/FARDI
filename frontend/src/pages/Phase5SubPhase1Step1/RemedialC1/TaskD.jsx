...
export default function Phase5Step1RemedialC1TaskD() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase5/subphase/1/step/1/remedial/c1/task/e') }, [])
  ...
  const canNext = !!(critiques[currentIndex].trim())
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{
            ...
            <Typography variant="h6" gutterBottom fontWeight="bold">Task D: Critique Kahoot</Typography>
          ...
          <>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
              <Box sx={{
                ...
                <Typography variant="h6" gutterBottom sx={{ color: P.blue.border }}>Strategy: {STRATEGIES[currentIndex].strategy}</Typography>
                ...
                <TextField
                  ...
                  placeholder="Write your nuanced critique here (8+ words)..."
                  value={critiques[currentIndex]} onChange={(e) => handleCritiqueChange(e.target.value)}
                  sx={{ mb: 2 }}
                />
