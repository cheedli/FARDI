...
export default function Phase5Step1RemedialB2TaskE() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase5/subphase/1/step/1/remedial/b2/task/f') }, [])
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{
            ...
            <Typography variant="h6" gutterBottom fontWeight="bold">Task E: Conditional Challenge</Typography>
          ...
          <>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
              <Box sx={{
                ...
                <Typography variant="h6" gutterBottom sx={{ color: P.blue.border }}>{CONDITIONAL_SENTENCES[currentIndex].template}</Typography>
