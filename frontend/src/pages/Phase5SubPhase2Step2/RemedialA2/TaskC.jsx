...
export default function Phase5SubPhase2Step2RemedialA2TaskC() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 2, step: 2, interaction: 3, context: 'remedial_a2' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(2, 'A2', 'C', finalScore, 6, 2) } catch (e) { console.error(e) }
  }

  const handleContinue = async () => navigate(await resolveSubphase2RemedialNextUrl(2, 'A2'))
