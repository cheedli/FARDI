...
export default function Phase6SP2Step2Score() {
  ...
  usePhase6ScoreResume({ subphase: 2, step: 2, scores, routing })
  ...
  useEffect(() => {
    const calc = async () => {
      ...
      const i2 = parseInt(sessionStorage.getItem('phase6_sp2_step2_interaction2_score') || '2')
      ...
      const fallbackRouting = getSubphase2MainRouting(2, i2)
      ...
      sessionStorage.setItem('phase6_sp2_step2_total_score', resolvedTotal.toString())
          ...
          <Box sx={{ ...cardSx(P.yellow), mb: 3 }}>
            ...
            <Stack spacing={2} sx={{ mt: 2 }}>
              {[
                ...
                { label: 'Interaction 2 (Feedback Choice Explanation)', score: scores.i2, max: 5 },
