...
export default function Phase6SP2Step2RemB2TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase6/subphase/2/step/2/remedial/b2/task/b') }, [])
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <Box sx={{ ...cardSx(P.orange), mb: 3 }}>
            <Typography variant="h5" fontWeight="bold" gutterBottom sx={{ color: P.orange.border }}>Step 2: Remedial B2 — Task A</Typography>
            <Typography variant="body1" sx={{ color: 'text.secondary' }}>Role-Play Dialogue: Trial Peer Feedback</Typography>
          </Box>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.4 }}>
          ...
          <Alert severity="info" sx={{ mb: 3, borderRadius: '12px' }}>Complete the trial peer feedback dialogue. Use the positive sandwich: positive → weakness/suggestion → positive.</Alert>
          ...
          {!submitted ? (
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
              <Box sx={{ ...cardSx(P.green), textAlign: 'center' }}>
                ...
                <Box component="button" onClick={() => navigate('/phase6/subphase/2/step/2/remedial/b2/task/b')}
