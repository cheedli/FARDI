...
export default function Phase6SP2Step2RemB2TaskD() {
  ...
  React.useEffect(() => { resolveSubphase2RemedialNextUrl(2, 'B2').then(url => { window.__remedialSkip = () => navigate(url) }) }, [])
        ...
        <Container maxWidth="md">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            <Box sx={{ ...cardSx(P.green), textAlign: 'center' }}>
              ...
              <Box component="button" onClick={async () => navigate(await resolveSubphase2RemedialNextUrl(2, 'B2'))}
