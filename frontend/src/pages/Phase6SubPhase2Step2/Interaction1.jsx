      ...
      <Container maxWidth="lg">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <Box sx={{ ...cardSx(P.blue), mb: 3 }}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary' }}>Sushi Spell — Spell vocabulary words correctly</Typography>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.4 }}>
          <Box sx={{ ...cardSx(P.teal), mb: 3 }}>
            <Typography variant="body1" sx={{ fontStyle: 'italic' }}>
              Ms. Mabrouki: "Play Sushi Spell, then write a short piece of peer feedback (3-5 sentences) on a sample report section I'll give you. Be specific and use words from the game."
            </Typography>
          </Box>
        </motion.div>
