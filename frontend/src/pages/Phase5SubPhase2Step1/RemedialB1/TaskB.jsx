...
export default function Phase5SubPhase2Step1RemedialB1TaskB() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 2, step: 1, interaction: 2, context: 'remedial_b1' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(1, 'B1', 'B', correctCount, 6, 2) } catch (e) { console.error(e) }
  }
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...clay(P.orange), mb: 3 }}>
            ...
            <Typography variant="body1" sx={{ color: theme.palette.text.secondary }}>Write 6 sentences giving instructions to volunteers. Build instructions like puzzle pieces!</Typography>
          </Box>
        </motion.div>
