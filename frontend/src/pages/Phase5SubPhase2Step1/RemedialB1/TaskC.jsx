...
export default function Phase5SubPhase2Step1RemedialB1TaskC() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 2, step: 1, interaction: 3, context: 'remedial_b1' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(1, 'B1', 'C', correctCount, 6, 2) } catch (e) { console.error(e) }
  }

  const handleContinue = async () => navigate(await resolveSubphase2RemedialNextUrl(1, 'B1'))
