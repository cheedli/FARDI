...
export default function Phase5SubPhase2Step1RemedialC1TaskA() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 2, step: 1, interaction: 1, context: 'remedial_c1' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(1, 'C1', 'A', finalScore, 4, 2) } catch (e) { console.error(e) }
  }

  const handleContinue = () => navigate('/phase5/subphase/2/step/1/remedial/c1/task/b')
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...clay(P.orange), mb: 3 }}>
            ...
            <Typography variant="body1" sx={{ color: theme.palette.text.secondary }}>Simulate dialogue discussing best ways to instruct volunteers. Show advanced discussion skills!</Typography>
          </Box>
        </motion.div>
