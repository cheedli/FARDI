...
export default function Phase6SP1Step1RemB2TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase6/subphase/1/step/1/remedial/b2/task/b') }, [])
      ...
      <Container maxWidth="md">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{
            ...
            <Typography variant="h6" gutterBottom sx={{ color: P.orange.shadow }}>Task A: Reflection Dialogue Quest</Typography>
            <Typography variant="body1" sx={{ color: P.orange.shadow }}>Complete the dialogue reflecting on the festival</Typography>
          </Box>
        </motion.div>
        ...
        <Box sx={{
          ...
          <Typography variant="body2" fontWeight="bold" sx={{ color: P.blue.shadow, mb: 1 }}>
            Word Bank:
          </Typography>
        ...
        {!submitted ? (
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            <Box sx={{
              ...
              <Box
                component="button"
                onClick={() => navigate('/phase6/subphase/1/step/1/remedial/b2/task/b')}
                sx={{
                  cursor: 'pointer',
                  mt: 2,
                  px: 4,
