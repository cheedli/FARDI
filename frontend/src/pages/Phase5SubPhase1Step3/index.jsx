      ...
      <Container maxWidth="md">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.22 }}>
          <Box sx={{ ...cardSx(P.orange), mb: 3 }}>
            ...
            <Stack spacing={1}>
              <Typography variant="body2" color="text.secondary"><strong>Interaction 1:</strong> Watch videos on crisis communication basics</Typography>
              <Typography variant="body2" color="text.secondary"><strong>Interaction 2:</strong> Read real crisis communication examples</Typography>
              <Typography variant="body2" color="text.secondary"><strong>Interaction 3:</strong> Play Sushi Spell and explain terms</Typography>
            </Stack>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
          <Box sx={{ ...cardSx(P.teal), mb: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary">1. Play Wordshake to activate vocabulary (3 minutes)</Typography>
            <Typography variant="body2" color="text.secondary">2. Watch videos and define 'contingency' plan</Typography>
            <Typography variant="body2" color="text.secondary">3. Read examples and explain 'transparent' communication</Typography>
            <Typography variant="body2" color="text.secondary">4. Play Sushi Spell and explain one term relating to the videos</Typography>
          </Box>
        </motion.div>
