...
export default function Phase6SP2Step5RemA2TaskC() {
  ...
  React.useEffect(() => { resolveSubphase2RemedialNextUrl(5, 'A2').then(url => { window.__remedialSkip = () => navigate(url) }) }, [])
