...
export default function Phase6SP2Step5Int2() {
  ...
  const { saveResponse } = useProgressSave({ phase: 6, subphase: 2, step: 5, interaction: 2, context: 'main' })
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...cardSx(P.blue), mb: 3 }}>
            ...
            <Typography variant="body1" sx={{ color: P.blue.shadow }}>Tone and Politeness Fix</Typography>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Box sx={{ ...cardSx(P.teal), mb: 3 }}>
            <Typography variant="body1" sx={{ fontStyle: 'italic', color: P.teal.shadow }}>
              Lilia: "Good spelling fixes! Now fix the tone and politeness issues in this feedback. Make it constructive and professional."
            </Typography>
          </Box>
        </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
            <Box sx={{ ...cardSx(P.green), mb: 3 }}>
              ...
              {submitted && (
                <Box
                  component="button"
                  onClick={() => navigate('/phase6/subphase/2/step/5/interaction/3')}
                  sx={{
                    width: '100%',
