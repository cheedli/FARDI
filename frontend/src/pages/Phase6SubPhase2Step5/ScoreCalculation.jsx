...
export default function Phase6SP2Step5Score() {
  ...
  usePhase6ScoreResume({ subphase: 2, step: 5, scores, routing })
  ...
  useEffect(() => {
    const calc = async () => {
      ...
      const i2 = parseInt(sessionStorage.getItem('phase6_sp2_step5_interaction2_score') || '2')
      ...
      const fallbackRouting = getSubphase2MainRouting(5, i2)
      ...
      sessionStorage.setItem('phase6_sp2_step5_total_score', resolvedTotal.toString())
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...cardSx(P.blue), mb: 3 }}>
            ...
            <Typography variant="h5" sx={{ color: P.blue.shadow }}>Step 5: Score Summary</Typography>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Box sx={{ ...cardSx(P.yellow), mb: 3 }}>
            ...
            <Stack spacing={2} sx={{ mt: 2 }}>
              {[{ label: 'Interaction 1', score: scores.i1, max: 1 }, { label: 'Interaction 2 (Spelling Correction)', score: scores.i2, max: 5 }, { label: 'Interaction 3', score: scores.i3, max: 1 }].map((item, idx) => (
