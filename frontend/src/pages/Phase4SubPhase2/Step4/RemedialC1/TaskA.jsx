...
export default function Phase4_2Step4RemedialC1TaskA() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4_2/step/4/remedial/c1/taskB') }, [])
  const { saveResponse } = useProgressSave({ phase: 4, subphase: 2, step: 4, interaction: 1, context: 'remedial_c1' })
