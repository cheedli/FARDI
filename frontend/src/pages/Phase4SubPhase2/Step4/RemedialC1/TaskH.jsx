...
export default function Phase4_2Step4RemedialC1TaskH() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4_2/step/4/remedial/c1/results') }, [])
  const { saveResponse } = useProgressSave({ phase: 4, subphase: 2, step: 4, interaction: 8, context: 'remedial_c1' })
