...
const Results = () => {
  ...
  useEffect(() => {
    ...
    requestPhase42FinalScore(5, 'b2', { total_score: total })
      .then((data) => {
      ...
      .catch((error) => console.error('Failed to calculate Phase 4.2 Step 5 B2 final score:', error));
  }, []);
  ...
  const handleDashboard = () => navigate('/phase4_2/step/5/remedial/c1/taskA');
