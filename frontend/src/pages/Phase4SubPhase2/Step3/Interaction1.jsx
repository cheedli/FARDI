...
function Phase4_2Step3Interaction1() {
  ...
  useEffect(() => { window.__remedialSkip = () => navigate('/phase4_2/step/3/interaction/2') }, [])
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        sessionStorage.setItem('phase4_2_step3_int1_score', data.score.toString())
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <Box sx={{
            ...
            <Box sx={{ mb: 2, p: 2, bgcolor: isDark ? 'rgba(255,255,255,0.05)' : 'white', borderRadius: '12px', border: `1px solid ${P.orange.border}` }}>
              <Link
          ...
          <Box sx={{
            ...
            <Box component="span" sx={{
              ...
              Hint: Use "It is words under..." and mention one example from the video.
            </Box>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center' }}>
              <Box component="button" onClick={handleSubmit}
                ...
                sx={{
                  ...
                  cursor: (loading || submitted || !definition.trim()) ? 'not-allowed' : 'pointer',
                  color: P.orange.shadow, opacity: (loading || submitted || !definition.trim()) ? 0.5 : 1,
