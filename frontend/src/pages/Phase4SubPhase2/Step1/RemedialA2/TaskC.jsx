...
export default function Phase4_2RemedialA2TaskC() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4_2/step/1/remedial/a2/results') }, [])
  const { saveResponse } = useProgressSave({ phase: 4, subphase: 2, step: 1, interaction: 3, context: 'remedial_a2' })
