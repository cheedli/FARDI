...
export default function RemedialB1TaskD() {
  ...
  React.useEffect(() => { window.__remedialSkip = () => navigate('/phase4/remedial/b2/taskA') }, [])
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const nextUrl = data.data.next_url || (passed ? '/phase4_2/step/1' : '/phase4/remedial/b1/taskA')
    ...
    setTimeout(() => {
      ...
      navigate(sessionStorage.getItem('phase4_step1_b1_next_url') || (passed ? '/phase4_2/step/1' : '/phase4/remedial/b1/taskA'))
    }, 5000)
  }
