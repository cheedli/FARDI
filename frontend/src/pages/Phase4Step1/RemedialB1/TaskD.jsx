  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const nextUrl = data.data.next_url || (passed ? '/phase4/step/2' : '/phase4/remedial/b1/taskA')
    ...
    setTimeout(() => {
      ...
      navigate(sessionStorage.getItem('phase4_step1_b1_next_url') || (passed ? '/phase4/step/2' : '/phase4/remedial/b1/taskA'))
    }, 5000)
  }
