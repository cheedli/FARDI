...
export default function Phase5Step5ScoreCalculation() {
  ...
  const calculateScore = async () => {
    ...
    try {
      ...
      setScores({ interaction1: interaction1Score, interaction2: interaction2Score, interaction3Game: interaction3GameScore, interaction3Enhancement: interaction3EnhancementScore, total: totalScore })
      ...
      <Container maxWidth="md">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          <Box sx={{ ...clay(P.blue), mb: 3 }}>
            ...
            <Typography variant="h5" gutterBottom sx={{ color: P.blue.border }}>Step 5: Score Summary</Typography>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Box sx={{ ...clay(P.yellow), mb: 3 }}>
            ...
            <Stack spacing={2} sx={{ mt: 2 }}>
              {[
                { label: 'Interaction 1 (Spelling)', val: scores.interaction1, max: 5 },
                { label: 'Interaction 2 (Grammar)', val: scores.interaction2, max: 5 },
                { label: 'Interaction 3 (Game)', val: scores.interaction3Game, max: 1 },
                { label: 'Interaction 3 (Enhancement)', val: scores.interaction3Enhancement, max: 5 },
              ].map((item, idx) => (
