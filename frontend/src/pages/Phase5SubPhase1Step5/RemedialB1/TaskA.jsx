...
export default function Phase5Step5RemedialB1TaskA() {
  ...
  const { saveResponse } = useProgressSave({ phase: 5, subphase: 1, step: 5, interaction: 1, context: 'remedial_b1' })
  ...
  const handleSubmit = async () => {
    ...
    try { await phase5API.logRemedialActivity(5, 'B1', 'A', finalScore, 5, 0) } catch (e) { console.error(e) }
  }

  const handleContinue = () => { navigate('/phase5/subphase/1/step/5/remedial/b1/task/b') }
