...
export default function Phase6SP2Step1RemB1TaskC() {
  ...
  React.useEffect(() => { resolveSubphase2RemedialNextUrl(1, 'B1').then(url => { window.__remedialSkip = () => navigate(url) }) }, [])
          ...
          {!submitted ? (
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
              <Box sx={{ ...cardSx(P.green), textAlign: 'center', mt: 2 }}>
                ...
                <Box
                  component="button"
                  onClick={async () => navigate(await resolveSubphase2RemedialNextUrl(1, 'B1'))}
                  sx={{
