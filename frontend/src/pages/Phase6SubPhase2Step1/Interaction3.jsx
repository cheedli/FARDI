...
export default function Phase6SP2Step1Int3() {
  ...
  const { saveResponse } = useProgressSave({ phase: 6, subphase: 2, step: 1, interaction: 3, context: 'main' })
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <Box sx={{ ...cardSx(P.blue), mb: 3 }}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary' }}>
              Sushi Spell — Spell vocabulary correctly
            </Typography>
          </Box>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.4 }}>
          <Box sx={{ ...cardSx(P.teal), mb: 3 }}>
            <Typography variant="body1" sx={{ fontStyle: 'italic', color: 'text.primary' }}>
              Emna: "Play Sushi Spell with peer feedback words! Spell: feedback, constructive, positive, suggestion, strength."
            </Typography>
          </Box>
        </motion.div>
